...
<div class="col-md-12">
  ...
  <div class="container">
    ...
    <div class="col-md-3">
      <div class="form-group">
        <input type="date" name="fecha" id="datepicker" name="datepicker">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <select name="depto" class="form-control selectpicker" onchange="redireccion();"  data-live-search="true" id="depto">
          <option value="">Eliga el departamento</option>
          @foreach ($users as $m2)
          <option value="{{$m2->name}}">{{$m2->name}}</option>
...
<script type="text/javascript">
 ...
 function redireccion()
 {
  ...
  var anio = fecha.substr(0,4);
    ...
    var capturar = capturar1+ '/'+nombre
    
    var ruta=  '/list_fechas3/'+capturar;
